...
from tmc.views import helper_signup, host_signup, jury_signup, landing, recordings, signup, update_documents, update_signup, upload_recording, view_helper, view_jury, view_signup, login_view, view_host
