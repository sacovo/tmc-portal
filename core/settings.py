...
The TMC Team!""",
        "content of e-mail sent to participants.",
    ),
    "AUTH_SUBJECT": (
        "Your TMC login | Dein TMC Zugang",
        "subject of e-mail with login link",
    ),
    "AUTH_TEXT": (
...
""",
    ...
    "HOST_SIGNUP_TEXT": (
        """Hallo {inscription.given_name} {inscription.surname}
...
Danke für deine Anmeldung als Gastfamilie für The Muri Competition. Du kannst deine Angaben jederzeit mit diesem Link anpassen: {auth_link}.\n\n Liebe Grüsse, das TMC Team""",
    ...
    "JURY_SIGNUP_TEXT": (
        "Registration Jury TMC",
        "text sent to jury members after account is created",
    ),
    "JURY_SIGNUP_SUBJECT": (
    ...
    "HELPER_SIGNUP_SUBJECT": (
        "Anmeldung als Helfer beim TMC",
        "subject of mail sent to new helpers",
    ),
    "HELPER_SIGNUP_TEXT": (
...
AWS_QUERYSTRING_EXPIRE = 60 * 60 * 24 * 5
